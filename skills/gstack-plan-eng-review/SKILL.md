...
interactive: true
version: 1.0.0
description: Vendored gstack engineering-manager plan review for Codex architecture workflows. Use when the architecture role needs to lock in execution plans, review data flow, edge cases, tests, performance, and implementation risks before opening downstream role windows.
